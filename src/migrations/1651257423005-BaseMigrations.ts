...
export class BaseMigrations1651257423005 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "licensees" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created" TIMESTAMP NOT NULL DEFAULT now(), "modified" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL DEFAULT '', "email" character varying NOT NULL DEFAULT '', "role" text NOT NULL DEFAULT '', "notes" text NOT NULL DEFAULT '', CONSTRAINT "UQ_1de4f2d708eb718e5c4160fe46d" UNIQUE ("email"), CONSTRAINT "PK_c0cad3879f874b089aa2d2b6185" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
